<footer class="pt-4 pt-md-5 pb-2 pb-md-4 bg-dark second-footer">
  <div class="container">
    <div class="row pt-3 pt-md-4">
      <div class="col-md-4 mb-3">
        <img src="{{ asset('assets/logo.svg') }}" alt="Brand" class="mb-2" style="max-width: 50px">
        <p class="lh-md text-sm text-muted">
            School was established in April, 2014. It got affiliated to Central Board of
             Secondary Education in 2016. We have thye best infrastructure in whole of
             Kangra District and most of our students stood first in Children Science
             Congress.We are proud to announce that we have 100% result since 2016.
        </p>
      </div>
      <div class="col mb-3">
        <h6 class="font-weight-bold text-white">The School</h6>
        <ul class="list-unstyled footer-link">
          <li>
            <a href="javascript:void(0);"  class="text-muted" >Rules And Regulation</a>
          </li>
          <li>
            <a href="javascript:void(0);"  class="text-muted" >Admission</a>
          </li>
          <li>
            <a href="javascript:void(0);"  class="text-muted" >School Infomation</a>
          </li>
          <li>
            <a href="javascript:void(0);"  class="text-muted" >Academics</a>
          </li>
        </ul>
      </div>
      <div class="col mb-3">
        <h6 class="font-weight-bold text-white">Useful Links</h6>
        <ul class="list-unstyled footer-link">
          <li>
            <a href="javascript:void(0);"  class="text-muted" >Blogs</a>
          </li>
          <li>
            <a href="javascript:void(0);"  class="text-muted" >Transfer Certificate</a>
          </li>
        </ul>
      </div>
      <div class="col mb-0 mb-md-3">
        <h6 class="font-weight-bold text-white">Contact</h6>
        <ul class="list-unstyled footer-link text-gray">
          <li  class="text-muted">
            <i class="fa fa-home"></i> Bhatti-Khoula, Jawalamukhi, Kangra, India
          </li>
          <li  class="text-muted">
            <i class="fa fa-envelope"></i> info@jmukhisics.in
          </li>
          <li  class="text-muted">
            <i class="fa fa-phone"></i>  +918988255242, <br>+918219626192
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-sm-5 order-sm-2">
        <div class="social-icons">
          <a href="javascript:void(0);"  class="text-muted" ><svg data-name="icons/tabler/facebook" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 16 16">
          ...
          <a href="javascript:void(0);"  class="text-muted" ><svg data-name="icons/tabler/dribbble" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 16 16">
          ...
          <a href="javascript:void(0);"  class="text-muted" ><svg data-name="icons/tabler/instagram" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 16 16">
      ...
      <div class="col-sm-7">
        <p class="small text-muted text-center text-sm-left mb-2">© 2021 . All rights reserved.</p>
      </div>
    </div>
  </div>
</footer>
